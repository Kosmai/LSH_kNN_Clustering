...
int readClArguments(int argc, char **argv, std::string &inputFile, std::string &queryFile, int &k, int &m, int &probes,
    ...
    if (readLshConfig("config/lsh.conf", argumentsRed, inputFile, queryFile, k, m, probes,
